...
from optimisation.qLogNEHVI import run_qlognehvi  # use your actual filename
...
with open("results/generated/classA/problems.pkl", "rb") as f:
    problems = pickle.load(f)

with open("results/generated/classA/hub_list.pkl", "rb") as f:
    hub_list = pickle.load(f)

with open("results/generated/classA/evaluatorparams.pkl", "rb") as f:
...
for problem_nr in range(0,nr_of_problems):
    ...
    # qLogNEHVI optimises turbines only and uses this fixed hub
    df, feas, model = run_qlognehvi(
        ...
        save_csv=True,
        csv_path=(
            f"results/qlognehvi_classA_problem_{problem_nr + 1}"
