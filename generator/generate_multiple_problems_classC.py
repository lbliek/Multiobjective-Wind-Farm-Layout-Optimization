...
problem_seed = 555555555
algorithm_seed = 555555555
...
config = GeneratorConfig(
    ...
    n_reservoirs=4,
    context_side=3,
    target_feasible_coverage_percent=96.0,
    reservoir_coverage_percent=12.0,
    # reservoir_coverage_percent=[10.0, 15.0, 7.0],
    max_reservoir_attempts=10000,
    external_reservoir_center=(5.3,5.3)
)
...
for problem_nr in range(nr_of_problems):
    ...
    bird_sigma = 5+14*np.random.rand() # random std for bird group between 5 and 19
